...
<table style="width:100%">
  <tr>
    <td style="text-align:right"><h5 style="text-align:center">เลขที่ SE'.date('Ymd').'-'.$customer_id.'</h5> </td>
  </tr>
</table>
...
<table style="width:100%">
  <tr>
    ...
    <td style="text-align:right"><h2 style="text-align:center">ใบส่งสินค้า </h2> </td>
  </tr>
</table>
...
<span>หมายเลขโทรศัพท์ : '.$row_customer['tel'].' &nbsp;หมายเลขโทรศัพท์เคลื่อนที่ : '.$row_customer['telephone'].'</span><br />
